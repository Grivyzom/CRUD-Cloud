...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        try {
            ...
            $stmt->execute([$title, $author, $isbn, $year, $quantity]);
            
            setFlashMessage('Libro agregado exitosamente');
            header('Location: index.php');
            exit;
        } catch (Exception $e) {
            $errors[] = 'Error al guardar el libro: ' . $e->getMessage();
        }
    }
}
?>
        ...
        <div class="max-w-md mx-auto">
            <div class="bg-white rounded-lg shadow-md p-6">
                <div class="flex items-center justify-between mb-6">
                    <h1 class="text-2xl font-bold text-gray-800">Agregar Libro</h1>
